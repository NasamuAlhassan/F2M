...
// real seller dashboard once tomorrow's design files land, not extended.
    ...
    <div className="mx-auto max-w-2xl px-4 py-10">
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-[var(--ink-6)]">Seller</p>
        </div>
      ...
      <p className="text-sm text-[var(--ink-6)]">
        Listing and lot management still run on the existing Seller Desk (see /farmer/login) — this dashboard is a
